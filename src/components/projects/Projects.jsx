...
export default function Projects() {
    ...
    const data = [
        {
            ...
            img: "./assets/projects/penntix.png",
        },
        {
            id: "2",
            icon: "./assets/projects/data.png",
            ...
            img: "./assets/projects/545.png",
        },
        {
            id: "3",
            icon: "./assets/projects/mine.png",
            title: "minesweeper",
            ...
            tools: "Java",
            img: "./assets/projects/minesweeper.png",
        },
        {
            id: "4",
            icon: "./assets/projects/claire.png",
            ...
            img: "./assets/projects/personalsite.png",
        },
    ...
    return (
        <div className="projects" id="projects">
            ...
            <img src="./assets/whitearrow.png"  className="arrow left" alt="" onClick={()=>handleClick("left")} />
            <img src="./assets/whitearrow.png"  className="arrow right" alt="" onClick={()=>handleClick("right")}/>
        </div>
    )
}