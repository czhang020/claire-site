            ...
            <div className="container">
                <div className="left">
                    ...
                    <div className="listContainer">
                        ...
                        <a href="https://www.youtube.com/watch?v=y7bkqZo_dmA" target="_blank"><img src="./assets/play.png"></img></a>             
                    </div>
                </div>
                <div className="center">
                    <div className="imgContainer">
                        <img src="./assets/czhangz.jpg" alt=""/>
                    </div>
                    <h3>this is me</h3>
                ...
                <div className="right">
                    ...
                    <div className="container">
                        ...
                        <img src="./assets/violin.png" alt=""/>
                        <h4>stuffed animals, especially sharks</h4>
                        <img src="./assets/shark.png" alt=""/>
                        <h4>playing pool</h4>
                        <img className="pool" src="./assets/pool.png" alt=""/>
                    </div>
                </div>
            </div>
        </div>
